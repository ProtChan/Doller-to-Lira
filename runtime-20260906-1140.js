(() => {
  ...
  Promise.all([
    ...
    .then(([appSource, accountingSource, swapDecimalSource, calendarSource, pwaSource, accessLayoutSource, swapPrecisionSource, hiroseHistorySource, hiroseRateHistorySource, hirosePendingBootstrapSource, hiroseInputSettleSource, closeConversionSource, capitalHistorySource, rateEditPerformanceSource, userPreparedRateSource, worstAskRiskSource, referenceDataRebuildSource, privatePublisherDailyLayoutSource, liveRateRefreshSource, sameDaySwapValuationSource]) => {
      ...
      if (status) status.innerHTML = '<i></i>LOCAL · 0052';
    })
