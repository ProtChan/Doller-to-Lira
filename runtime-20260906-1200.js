(() => {
  ...
  Promise.all([
    ...
    fetch(`./patch-hirose-swap-margin-20260906.js?runtime=${BUILD}`, { cache: 'no-store' }).then((r) => {
    ...
    .then(([appSource, accountingSource, swapDecimalSource, hiroseSource, calendarSource, pwaSource]) => {
